...
| 20 | [lioensky/VCPToolBox](https://github.com/lioensky/VCPToolBox) | 2293 | JavaScript | 2026-09-10 | VCP 部署在 AI 模型 API 与前端应用之间，是面向AGI OS开发和探索的工业级基建示范项目。通过统一指令协议、多层级持久化记忆、分布式插件引擎及多 Agent 协作框架，将原本“无状态、无记忆、无工具调用能力”的大语言模型，彻底改 |
| 21 | [mohabdelkarim/awesome-ai-resources](https://github.com/mohabdelkarim/awesome-ai-resources) | 0 | Python | 2026-09-10 | Roadmap first free and legal AI resources: courses, books, papers, tools, APIs, labs, and communities, ordered from foun |
| 22 | [zenstory-ai/drama-skills](https://github.com/zenstory-ai/drama-skills) | 1756 | Python | 2026-09-10 | AI 短剧/漫剧创作 skill 合集，覆盖剧本、资产、分镜、图片/视频提示词到独立审查全链路，适配 Claude Code 与 Codex。\| An AI short-drama skill suite for Claude Code & |
| 23 | [qrex102300-ui/opc-clinic](https://github.com/qrex102300-ui/opc-clinic) | 3 | HTML | 2026-09-10 | 一个会拷问你的 AI 创业诊断官 · 不给通用建议,只逼你看清真病因 \| An AI diagnostician that interrogates your startup |
| 24 | [BotShelfVampire/botshelf](https://github.com/BotShelfVampire/botshelf) | 0 | — | 2026-09-10 | BotShelf Vampire: free, focused AI prompt packs for Grok Bot, Claude Code and ChatGPT. Practical research, writing and c |
| 25 | [T-Stephen/ai-mql-engine](https://github.com/T-Stephen/ai-mql-engine) | 2 | JavaScript | 2026-09-10 | AI-powered MongoDB Query (MQL) generation engine with prompt engineering, validation, and analytics for natural language |
| 26 | [naodeng/awesome-qa-skills](https://github.com/naodeng/awesome-qa-skills) | 204 | Python | 2026-09-10 | Awesome QA Skills is an open-source AI-native Quality Engineering skill system that helps engineering teams reason about |
...
| 28 | [FuHehe12/cc-wire-analyzer](https://github.com/FuHehe12/cc-wire-analyzer) | 3 | HTML | 2026-09-10 | Local Claude Code HTTP traffic inspector with a desktop GUI and agent API. Capture prompts, tools, SSE, errors, and toke |
| 29 | [sultan-repo/forge](https://github.com/sultan-repo/forge) | 0 | Python | 2026-09-10 | Project control for Claude Code: requirements enrichment, anti-drift execution, context recovery, agent orchestration, a |
| 30 | [ZhangJie86889/multisim-ai-circuits](https://github.com/ZhangJie86889/multisim-ai-circuits) | 0 | TypeScript | 2026-09-10 | 提示词驱动的 NI Multisim 14.3 电路库：AI 生成可导入的 .cir 网表 + 配套文档，人工仿真验证。含纯静态网页（电路浏览 / 提示词生成 / 在线网表检查）。 |
| 31 | [holtwood/awesome-cursorrules-zh](https://github.com/holtwood/awesome-cursorrules-zh) | 233 | JavaScript | 2026-09-10 | Cursor AI 编程规则精选集 \| 132+ 规则，覆盖前端/后端/AI/DevOps 等 32 个领域 |
...
| 33 | [cjsthecoder/project_syx](https://github.com/cjsthecoder/project_syx) | 0 | Python | 2026-09-10 | Syx is an experimental local AI memory system for long-running projects and coding agents. It explores active context, d |
| 34 | [GLFzr/QianBi-Novel](https://github.com/GLFzr/QianBi-Novel) | 7 | Python | 2026-09-10 | 千笔一文 Novel — 人 AI 共写的长篇网文创作台：条目化世界书 · 正则 must 契约（确定性复检，违规拦住锁定）· 三层审校（引证验真 + 投票）· 同人文外部导入可整批撤销 · 升级不动书稿 · BYOK 全本地 · MIT。 |
| 35 | [Jia-Ethan/codex-keysmith](https://github.com/Jia-Ethan/codex-keysmith) | 4405 | Python | 2026-09-10 | Versioned Codex instruction deployment with preview, ownership manifests, hook isolation, scenario evaluation, and recov |
| 36 | [comet-ml/opik](https://github.com/comet-ml/opik) | 21915 | Python | 2026-09-10 | Debug, evaluate, and monitor your LLM applications, RAG systems, and agentic workflows with comprehensive tracing, autom |
| 37 | [chriscantu/claude-config](https://github.com/chriscantu/claude-config) | 0 | TypeScript | 2026-09-10 | Portable, version-controlled Claude Code configuration — structured engineering workflows with problem definition, syste |
| 38 | [adnanmokhtar/refract](https://github.com/adnanmokhtar/refract) | 1 | Shell | 2026-09-10 | Write your AI coding setup once, run it in every tool. One source of truth — 149 commands, 88 agents, 116 skills, 23 rol |
| 39 | [yahyambk57-stack/Ai-Object-Isolation-Toolkit](https://github.com/yahyambk57-stack/Ai-Object-Isolation-Toolkit) | 50 | HTML | 2026-09-10 | 2026 Next-Gen AI Photo Background Remover & Object Removal Tool |
...
| 41 | [shauryagangrade/awesome-ai-prompts](https://github.com/shauryagangrade/awesome-ai-prompts) | 52 | Shell | 2026-09-10 | Curated copy-paste AI prompts for student developers - disciplined workflows for coding agents that verify, don't guess |
| 42 | [lizhuojunx86/traceguard](https://github.com/lizhuojunx86/traceguard) | 2 | Python | 2026-09-10 | Point-in-time correct LLM instrumentation — tracing, version pinning and look-ahead-bias protection for research pipelin |
| 43 | [Kenny27lokku/prompt-integrity-validator](https://github.com/Kenny27lokku/prompt-integrity-validator) | 2 | HTML | 2026-09-10 | Lint Your Prompts, Ship Better Agents – Prompt Refiner 2026 Rule Engine |
| 44 | [smixs/visual-skills](https://github.com/smixs/visual-skills) | 335 | — | 2026-09-10 | AI film director skills for agents: cinematic dramaturgy (Murch, blocking, montage) + exact prompt syntax for Seedance 2 |
| 45 | [tubasa821004-hash/social-manipulation-radar](https://github.com/tubasa821004-hash/social-manipulation-radar) | 1 | HTML | 2026-09-10 | AI Social Defense Toolkit 2026: Detect Manipulation & Counter Pickup Artist Tactics |
| 46 | [consolascionw/prompt-to-pattern-design](https://github.com/consolascionw/prompt-to-pattern-design) | 1 | HTML | 2026-09-10 | AI-Powered AST Context Engine: Outline-Driven Code Generation 2026 |
| 47 | [lobisomenhomemafeminado/skill-vault](https://github.com/lobisomenhomemafeminado/skill-vault) | 2 | HTML | 2026-09-10 | AI Skill Finder 2026: Automated Search & Install for Claude Code |
| 48 | [1449690477/SusuAIOverclock](https://github.com/1449690477/SusuAIOverclock) | 3 | JavaScript | 2026-09-10 | 苏苏 AI超频 · Susu AI Overclock — 六大 AI 工具包统一部署台，四层穿透验证 + 模型会话超频监控 |
| 49 | [tech-guru254/spec-weaver](https://github.com/tech-guru254/spec-weaver) | 1 | HTML | 2026-09-10 | Top AI Prompt Optimizer 2026 – Transform Vague Requests Into Structured Dev Specs |
| 50 | [kodancrash-oss/prompt-weaver-framework](https://github.com/kodancrash-oss/prompt-weaver-framework) | 1 | HTML | 2026-09-10 | Best Free Prompt Architect AI 2026 – Build Production Prompts with Claude's Interview Framework |
<!-- TRACKER_TABLE_END -->
