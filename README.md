...
| 21 | [SHENG5411/grimoire-of-tools](https://github.com/SHENG5411/grimoire-of-tools) | 0 | HTML | 2026-06-19 | Ultimate AI Spellbook Workflows 2026 – Build Multi-Platform Skills & Automation |
...
| 24 | [beatriangu/NutriPrompt](https://github.com/beatriangu/NutriPrompt) | 1 | Python | 2026-06-19 | AI-powered nutrition intelligence platform built with Django, Prompt Engineering, RAG, OCR and multi-provider AI orchest |
...
| 26 | [masa-san-jp/logs-with-llm](https://github.com/masa-san-jp/logs-with-llm) | 1 | Python | 2026-06-19 | LLM対話ログ、週次ブログ、Zenn記事、プロンプト資産、自動化スクリプトを管理 / Workspace for LLM logs, weekly blogs, Zenn articles, prompts, and automation  |
| 27 | [jestersanjay/slim-tools-claude-harness](https://github.com/jestersanjay/slim-tools-claude-harness) | 0 | HTML | 2026-06-19 | SLIM v2.0 Claude Code Plugin 2026 - Smart Automation for Dev Workflows |
| 28 | [ngu-gif/genai-role-playbook](https://github.com/ngu-gif/genai-role-playbook) | 0 | HTML | 2026-06-19 | GenAI Career Roadmap 2026 🚀 \| AI Job Paths & Skills Guide |
...
| 30 | [openmodelsrun/skills](https://github.com/openmodelsrun/skills) | 0 | Python | 2026-06-19 | Community-maintained catalog of AI agent skills — structured, searchable and integrated with the OpenModels ecosystem. |
...
| 33 | [teguhimanulloh47/pirate-talk-for-claude](https://github.com/teguhimanulloh47/pirate-talk-for-claude) | 0 | HTML | 2026-06-19 | Claude Pirate Speak Plugin 2026 - Best Free Avast Ye Translator GitHub |
...
| 35 | [dimitardamjan7-a11y/spec-flow-framework](https://github.com/dimitardamjan7-a11y/spec-flow-framework) | 0 | HTML | 2026-06-19 | Nam-Cheol/namba-ai → AI Work Manager: Turn Vague Ideas into PR-Ready Specs & Evidence 2026 |
| 36 | [Goldziher/prompt-template](https://github.com/Goldziher/prompt-template) | 23 | Python | 2026-06-19 | Flexible and lightweight library for creating prompt templates |
| 37 | [rmdhananjay/contextual-memory-map](https://github.com/rmdhananjay/contextual-memory-map) | 0 | HTML | 2026-06-19 | Runbook AI: Operational Memory & Execution Discipline for Coding Agents 2026 |
| 38 | [mlflow/mlflow](https://github.com/mlflow/mlflow) | 26617 | Python | 2026-06-19 | The open source AI engineering platform for agents, LLMs, and ML models. MLflow enables teams of all sizes to debug, eva |
| 39 | [bhutano/steelprompt](https://github.com/bhutano/steelprompt) | 1 | HTML | 2026-06-19 | Claude Code hook that engineers every prompt using Anthropic's 10 official principles — automatically in Claude Code, on |
...
| 41 | [Darkmalan-1987/sparring-reason](https://github.com/Darkmalan-1987/sparring-reason) | 1 | HTML | 2026-06-19 | Claude Newton: AI Reasoning Partner 2026 - Calibrated Pushback & Current Sources |
| 42 | [salim4ek/medical-transcriber-by-salim4ek](https://github.com/salim4ek/medical-transcriber-by-salim4ek) | 0 | Python | 2026-06-19 | Medical consultation transcriber — audio to a structured Word document. Python pipeline: speech-to-text + Claude (Calgar |
| 43 | [sou350121/Agent-Playbook](https://github.com/sou350121/Agent-Playbook) | 12 | PowerShell | 2026-06-19 | ⚗️ AI Agent 生态每天海量资讯，99% 是噪音。这个仓库只做一件事：把最新碎片信号提纯为你能直接用的架构导轨、设计模式和工程实践。 |
| 44 | [manojmallick/skillweave](https://github.com/manojmallick/skillweave) | 0 | TypeScript | 2026-06-19 | An open standard and runtime for composing LLM tasks from small, focused, testable micro-skills — orchestration, schema  |
...
| 46 | [RemLeNoir/cts](https://github.com/RemLeNoir/cts) | 0 | Python | 2026-06-19 | Biblioteca de contratos semánticos en español para trabajar con IA: 251 transformaciones por dominio, de instrucción vag |
| 47 | [hungv47/meta-skills](https://github.com/hungv47/meta-skills) | 12 | TypeScript | 2026-06-19 | Turn your coding agent into a full product team — composable skills across research, marketing, product, and process. On |
| 48 | [robertomarchioro/prompt-a-porter](https://github.com/robertomarchioro/prompt-a-porter) | 0 | Rust | 2026-06-19 | Libreria locale-first per prompt AI — vault cifrato, ricerca semantica offline, MCP-ready, AGPL 3.0 |
| 49 | [luongs3/skill-atlas](https://github.com/luongs3/skill-atlas) | 0 | Python | 2026-06-19 | A trust-rated index of public AI-agent skills, organized by job. Tells your agent which skills to load for a task — and  |
| 50 | [promptslab/Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) | 6065 | TypeScript | 2026-06-19 | This repository contains a hand-curated resources for Prompt Engineering with a focus on Generative Pre-trained Transfor |
<!-- TRACKER_TABLE_END -->
