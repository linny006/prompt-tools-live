...
| 26 | [lobisomenhomemafeminado/skill-vault](https://github.com/lobisomenhomemafeminado/skill-vault) | 0 | HTML | 2026-06-16 | AI Skill Finder 2026: Automated Search & Install for Claude Code |
...
| 34 | [domaingitshub/odin-mirror-scribe](https://github.com/domaingitshub/odin-mirror-scribe) | 0 | HTML | 2026-06-16 | 🚀 ODIN Reflector 2026 – Next-Gen Meta-Reflection Engine for Outline-Driven AI Development |
...
| 42 | [dimitardamjan7-a11y/spec-flow-framework](https://github.com/dimitardamjan7-a11y/spec-flow-framework) | 0 | HTML | 2026-06-16 | Nam-Cheol/namba-ai → AI Work Manager: Turn Vague Ideas into PR-Ready Specs & Evidence 2026 |
| 43 | [Darkmalan-1987/sparring-reason](https://github.com/Darkmalan-1987/sparring-reason) | 1 | HTML | 2026-06-16 | Claude Newton: AI Reasoning Partner 2026 - Calibrated Pushback & Current Sources |
| 44 | [KareemShafie/Prompt-Quality-Evaluator](https://github.com/KareemShafie/Prompt-Quality-Evaluator) | 0 | Jupyter Notebook | 2026-06-16 | NLP project for automatic prompt quality evaluation using Mistral-7B, LoRA fine-tuning, Unsloth, and Streamlit. |
| 45 | [Supervertaler/Supervertaler-Workbench](https://github.com/Supervertaler/Supervertaler-Workbench) | 41 | Python | 2026-06-16 | Open-source, AI-enhanced CAT tool with multi-LLM support, translation memory, glossary management, 'Superlookup' concord |
| 46 | [Preelu/ai-policy-assistant](https://github.com/Preelu/ai-policy-assistant) | 0 | Python | 2026-06-16 | AI-powered policy document assistant built with Python and Streamlit for nonprofit and public-service organizations. |
| 47 | [JimmySadek/strategic-partner](https://github.com/JimmySadek/strategic-partner) | 23 | Shell | 2026-06-16 | Every other tool executes. This one decides what to execute. Chief of Staff skill for Claude Code. |
| 48 | [jnMetaCode/superpowers-zh](https://github.com/jnMetaCode/superpowers-zh) | 5456 | Shell | 2026-06-16 | 🦸 AI 编程超能力 · 中文增强版 — superpowers（116k+ ⭐）完整汉化 + 6 个中国原创 skills，让 Claude Code / Copilot CLI / Hermes Agent / Cursor / Win |
...
| 50 | [kodancrash-oss/prompt-weaver-framework](https://github.com/kodancrash-oss/prompt-weaver-framework) | 0 | HTML | 2026-06-16 | Best Free Prompt Architect AI 2026 – Build Production Prompts with Claude's Interview Framework |
<!-- TRACKER_TABLE_END -->
