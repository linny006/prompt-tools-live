...
| 20 | [JackZhong2017/body-root-cause-skill](https://github.com/JackZhong2017/body-root-cause-skill) | 0 | — | 2026-06-06 | 基于循证营养学的补剂组合 Claude Skill |
| 21 | [Open-Less/openless](https://github.com/Open-Less/openless) | 2177 | HTML | 2026-06-06 | Hold a key, speak, release — AI-polished text appears at your cursor in any app. Open-source voice input for macOS & Win |
| 22 | [RewriteReality-Labs/GBSE](https://github.com/RewriteReality-Labs/GBSE) | 1 | JavaScript | 2026-06-06 | Adversarial verification framework for AI outputs.  Recursive Solver → Auditor → Reconstructor pipeline  with benchmark- |
| 23 | [winstonkoh87/Athena-Public](https://github.com/winstonkoh87/Athena-Public) | 499 | Python | 2026-06-06 | The Linux OS for AI Agents — Persistent memory, autonomy, and time-awareness for any LLM. Own the state. Rent the intell |
| 24 | [vllm-project/semantic-router](https://github.com/vllm-project/semantic-router) | 4282 | Go | 2026-06-06 | System Level Intelligent Router for Mixture-of-Models at Cloud, Data Center and Edge |
| 25 | [Planetpliexpose/ai-shortfilm-prompts-508](https://github.com/Planetpliexpose/ai-shortfilm-prompts-508) | 0 | Python | 2026-06-06 | Methodology + prompts + Claude Code Skill behind Zombie Scavenger by Mx-Shell — the AI short PJ Ace called "one of the b |
| 26 | [silvesterdivas/context-engineer](https://github.com/silvesterdivas/context-engineer) | 0 | HTML | 2026-06-06 | Context engineering best practices for Claude Code. Budget zones, degradation detection, token-saving hooks, model switc |
| 27 | [MartiniArt/awesome-seedance-2-prompt](https://github.com/MartiniArt/awesome-seedance-2-prompt) | 0 | Shell | 2026-06-06 | Curated Seedance 2.0 video generation prompts, examples, workflows, and API guides by Martini Art. |
| 28 | [YouMind-OpenLab/awesome-nano-banana-pro-prompts](https://github.com/YouMind-OpenLab/awesome-nano-banana-pro-prompts) | 12413 | TypeScript | 2026-06-06 | 🍌 World's largest Nano Banana Pro prompt library — 10,000+ curated prompts with preview images, 16 languages. Google Gem |
| 29 | [repoprompt/repoprompt-ce](https://github.com/repoprompt/repoprompt-ce) | 173 | Swift | 2026-06-06 | Community edition of RepoPrompt: a native macOS context engineering app for AI coding agents, with an MCP CLI. |
| 30 | [simota/agent-skills](https://github.com/simota/agent-skills) | 48 | HTML | 2026-06-06 | 140+ specialized AI agent skills for Claude Code / Codex CLI / Antigravity CLI (agy) — prompt engineering assets coverin |
| 31 | [Paulessus/odin-gemini-mcp-bridge](https://github.com/Paulessus/odin-gemini-mcp-bridge) | 0 | HTML | 2026-06-06 | Odin Gemini CLI 2.0: Outline-Driven Dev Skills & Agents 2026 |
| 32 | [Fuchsiafromcurl/ai-shortfilm-prompts-299](https://github.com/Fuchsiafromcurl/ai-shortfilm-prompts-299) | 0 | Python | 2026-06-06 | Methodology + prompts + Claude Code Skill behind Zombie Scavenger by Mx-Shell — the AI short PJ Ace called "one of the b |
| 33 | [PablitoPJ/drifter-blueprint-vault](https://github.com/PablitoPJ/drifter-blueprint-vault) | 0 | HTML | 2026-06-06 | Odin Codex 2026: Outline-Driven AI Agent Workflows for Codex CLI |
| 34 | [jatinloey1598-dot/social-signals-analyzer](https://github.com/jatinloey1598-dot/social-signals-analyzer) | 0 | HTML | 2026-06-06 | Detect & Counter Pickup Artist Tactics 2026 – AI-Powered Social Defense Toolkit |
...
| 36 | [pbierkortte/ai-runbook](https://github.com/pbierkortte/ai-runbook) | 3 | HTML | 2026-06-06 | A dotfiles repo that treats AI agent behavior as infrastructure |
| 37 | [Gudvin82/vibe-coding-protocols](https://github.com/Gudvin82/vibe-coding-protocols) | 2 | Python | 2026-06-06 | Practical protocols and markdown templates for safer AI-assisted / vibe coding projects: Starter, Hardening, Architectur |
| 38 | [Elevated-homer201/prompt-gate](https://github.com/Elevated-homer201/prompt-gate) | 0 | — | 2026-06-06 | Filter LLM prompts and shield applications from data leakage using a specialized security gateway. |
| 39 | [acipaaa/context-llm-chunks](https://github.com/acipaaa/context-llm-chunks) | 0 | HTML | 2026-06-06 | The Best Srcpack Alternatives 2026: Optimize Code for LLMs Faster |
| 40 | [Highlydeveloped-trowel635/context-graph-compressor](https://github.com/Highlydeveloped-trowel635/context-graph-compressor) | 0 | — | 2026-06-06 | Compress chat histories into minimal JSON graphs to reduce token costs and maintain context across different LLM session |
| 41 | [vanth7067/chatgpt-gpt-5](https://github.com/vanth7067/chatgpt-gpt-5) | 1 | — | 2026-06-06 | Deploy the full ChatGPT desktop build for Windows with GPT-5 integration, DALL-E 4, and code interpreter tools. |
| 42 | [prasti8527/legal-ai-skills](https://github.com/prasti8527/legal-ai-skills) | 0 | Python | 2026-06-06 | Automate legal research, citation verification, and DOCX document processing with reusable AI agent skills compatible wi |
| 43 | [Maxiesuggestive393/claude-code-cli](https://github.com/Maxiesuggestive393/claude-code-cli) | 0 | TypeScript | 2026-06-06 | Automate coding tasks and manage git workflows inside your terminal using this agentic Claude-powered interface. |
| 44 | [sonu1611/sillytavern-ai-character-chat](https://github.com/sonu1611/sillytavern-ai-character-chat) | 0 | — | 2026-06-06 | Roleplay with custom AI characters using local LLMs, group chats, and text-to-speech in a private, fully offline interfa |
| 45 | [ngu-gif/genai-role-playbook](https://github.com/ngu-gif/genai-role-playbook) | 0 | HTML | 2026-06-06 | GenAI Career Roadmap 2026 🚀 \| AI Job Paths & Skills Guide |
| 46 | [herreravalenz6620/context-compression](https://github.com/herreravalenz6620/context-compression) | 1 | Python | 2026-06-06 | Reduce token usage for JSON, CSV, and TSV files with deterministic compression that keeps data intact for AI agents. |
| 47 | [Rickardserrulate236/portfolio-dumper](https://github.com/Rickardserrulate236/portfolio-dumper) | 1 | HTML | 2026-06-06 | Convert GitHub profiles and repositories into clean Markdown for use in documentation, portfolios, and AI prompts. |
| 48 | [Opsn5528/vibe-coding-claude-md](https://github.com/Opsn5528/vibe-coding-claude-md) | 1 | HTML | 2026-06-06 | Generate clean CLAUDE.md files for Claude Code with this single-file, offline tool that runs directly in your browser. |
| 49 | [ajayfastfooted329/claude-linkedin-post-creator](https://github.com/ajayfastfooted329/claude-linkedin-post-creator) | 1 | — | 2026-06-06 | Generate LinkedIn posts with a Claude Code assistant that analyzes your profile and industry trends to match your writin |
| 50 | [Dusty-plumcot781/locoagent](https://github.com/Dusty-plumcot781/locoagent) | 0 | — | 2026-06-06 | Automate social media accounts using an AI agent that navigates live web pages to perform tasks like liking posts and wr |
<!-- TRACKER_TABLE_END -->
