...
| 21 | [cobusgreyling/grok-bot-templates](https://github.com/cobusgreyling/grok-bot-templates) | 1 | JavaScript | 2026-08-29 | The engineering kit for Grok Bot templates. Spec, Bot Ready score, teams, skills, routines, and a catalog you can paste  |
| 22 | [foryourhealth111-pixel/Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3053 | Python | 2026-08-29 | VibeSkills is a general-purpose Skill that automatically routes local Skills and intelligently orchestrates harness work |
| 23 | [sergvss/agents-best-teams](https://github.com/sergvss/agents-best-teams) | 2 | Python | 2026-08-29 | Методология построения команды специализированных AI-агентов: явные роли, tier-маршрутизация, триангулированное ревью и  |
| 24 | [Mairaarshad19/FlyRankInternship-GeneralAIFluency](https://github.com/Mairaarshad19/FlyRankInternship-GeneralAIFluency) | 0 | HTML | 2026-08-29 | Assignments and projects for the FlyRank General AI Fluency internship track. |
| 25 | [3aKHP/Neural-Narratology](https://github.com/3aKHP/Neural-Narratology) | 0 | TypeScript | 2026-08-29 | Research on LLM Interactive Narrative: From Reverse Engineering to Automated Foundry. (Phase I-III) |
| 26 | [christopherlouet/claude-base](https://github.com/christopherlouet/claude-base) | 5 | Shell | 2026-08-29 | Opinionated Claude Code foundation — Explore → TDD → Audit workflow, auto-detected stack presets (nextjs, fastapi, astro |
| 27 | [Sharif-Abusad/langchain-learning](https://github.com/Sharif-Abusad/langchain-learning) | 0 | Python | 2026-08-29 | A hands-on LangChain repository covering LLMs, ChatModels, embeddings, document loaders, text splitters, prompt engineer |
| 28 | [rongxingda/dsh-prompt-enhance](https://github.com/rongxingda/dsh-prompt-enhance) | 1 | TypeScript | 2026-08-29 | Prompt enhancement plugin for the DeepSeek Harness web GUI: one-click rewrite of the composer draft into a structured pr |
| 29 | [letuandatt/AI-Radar](https://github.com/letuandatt/AI-Radar) | 1 | Python | 2026-08-29 | Knowledge Intelligence System for AI Research |
| 30 | [mukundzha/crilio](https://github.com/mukundzha/crilio) | 1 | Python | 2026-08-29 | A CI gate for testing AI prompts and preventing regressions. |
| 31 | [akashsebastian333/peephole](https://github.com/akashsebastian333/peephole) | 5 | Go | 2026-08-29 | Security enforcement for AI coding agents. Catch and block insecure code. |
| 32 | [conorbronsdon/agent-context-os](https://github.com/conorbronsdon/agent-context-os) | 15 | Python | 2026-08-29 | Portable, evolving context and workflow layer that works across Claude Code, Codex, Hermes Agent, and other compatible c |
| 33 | [promptry/promptry](https://github.com/promptry/promptry) | 4 | Python | 2026-08-29 | Local-first prompt regression testing and evals for LLM apps. |
| 34 | [Krishna-Modi12/frontend-design-pro](https://github.com/Krishna-Modi12/frontend-design-pro) | 6 | TypeScript | 2026-08-29 | Machine-enforced frontend UI/UX skill pack for AI agents. Registry + lazy loading: a 2,099-token router loads one skill  |
| 35 | [subhacademic-cmd/prompt-craft-ecommerce-visuals](https://github.com/subhacademic-cmd/prompt-craft-ecommerce-visuals) | 2 | HTML | 2026-08-29 | AI E-Commerce Visuals 2026: Ultimate GPT-Image Prompts Library ✨ |
| 36 | [ezBuilder/code-brain](https://github.com/ezBuilder/code-brain) | 11 | Python | 2026-08-29 | Persistent memory, BM25 code search, MCP tools, and hook guardrails for AI coding agents — Claude Code, Codex CLI & Anti |
| 37 | [TidyFactor/TidyFactor](https://github.com/TidyFactor/TidyFactor) | 11 | JavaScript | 2026-08-29 | ⚡ TidyFactor Architecture Ecosystem , AI-Native Web Architecture, Design Systems & Agent Skills . |
| 38 | [Michel-IT/Kotodama](https://github.com/Michel-IT/Kotodama) | 4 | Rust | 2026-08-29 | One desktop window for ChatGPT, Claude, Gemini, Grok, Perplexity, Qwen, DeepSeek and Z.ai. Fast, private, fully local. B |
| 39 | [izam-mohammed/ragrank](https://github.com/izam-mohammed/ragrank) | 47 | Python | 2026-08-29 | 🎯 Your free LLM evaluation toolkit helps you assess the accuracy of facts, how well it understands context, its tone, an |
| 40 | [promptslab/Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) | 6299 | TypeScript | 2026-08-29 | This repository contains a hand-curated resources for Prompt Engineering with a focus on Generative Pre-trained Transfor |
| 41 | [TidyFactor/Styler](https://github.com/TidyFactor/Styler) | 79 | Python | 2026-08-29 | Production-Stage Visual Design & In-Codebase UI Engineering Suite |
| 42 | [TidyFactor/skill-architect](https://github.com/TidyFactor/skill-architect) | 1 | JavaScript | 2026-08-29 | Skills Governance Layer & Skill Methodology Engine for AI Coding Agents |
| 43 | [TidyFactor/Next](https://github.com/TidyFactor/Next) | 3 | JavaScript | 2026-08-29 | Production-Grade Multi-Tenant SaaS Architecture & Development Performance Engine |
| 44 | [TidyFactor/Marketing](https://github.com/TidyFactor/Marketing) | 6 | JavaScript | 2026-08-29 | Marketing, Psychological Growth Engine & Anti-Slop Content Suite |
| 45 | [TidyFactor/JS](https://github.com/TidyFactor/JS) | 2 | JavaScript | 2026-08-29 | The Vanilla JS track of the TidyFactor skill library |
...
| 47 | [TidyFactor/HTMX](https://github.com/TidyFactor/HTMX) | 1 | JavaScript | 2026-08-29 | The HTMX Server-Driven Micro-Interactions track of the TidyFactor skill library |
| 48 | [SHENG5411/grimoire-of-tools](https://github.com/SHENG5411/grimoire-of-tools) | 2 | HTML | 2026-08-29 | Ultimate AI Spellbook Workflows 2026 – Build Multi-Platform Skills & Automation |
| 49 | [event4u-app/agent-config](https://github.com/event4u-app/agent-config) | 9 | TypeScript | 2026-08-29 | Every claim machine-checked, including "zero runtime daemon" — governed skills, rules and replayable state. One contract |
| 50 | [TidyFactor/Cinematic](https://github.com/TidyFactor/Cinematic) | 2 | HTML | 2026-08-29 | Produce high-impact, scroll-driven product films and luxury Cinematic Landing pages. |
<!-- TRACKER_TABLE_END -->
