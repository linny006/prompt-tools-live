...
| 27 | [mlflow/mlflow](https://github.com/mlflow/mlflow) | 27374 | Python | 2026-08-05 | The open source AI engineering platform for agents, LLMs, and ML models. MLflow enables teams of all sizes to debug, eva |
| 28 | [Open-Less/openless](https://github.com/Open-Less/openless) | 2958 | Rust | 2026-08-05 | Hold a key, speak, release — AI-polished text appears at your cursor in any app. Open-source voice input for macOS & Win |
| 29 | [fwdai/reticle](https://github.com/fwdai/reticle) | 30 | TypeScript | 2026-08-05 | Postman for AI - design, evaluate, and debug LLM interactions with full transparency. |
| 30 | [domaingitshub/odin-mirror-scribe](https://github.com/domaingitshub/odin-mirror-scribe) | 1 | HTML | 2026-08-05 | 🚀 ODIN Reflector 2026 – Next-Gen Meta-Reflection Engine for Outline-Driven AI Development |
| 31 | [sairaman436/vybe-intelligence-vault](https://github.com/sairaman436/vybe-intelligence-vault) | 15 | JavaScript | 2026-08-05 | An auto-updating open-source vault for AI agents, RAG systems, MCP servers, prompts, tools, templates, and next-generati |
| 32 | [nikolay-e/diffctx](https://github.com/nikolay-e/diffctx) | 2 | Rust | 2026-08-05 | Smart git diff context for LLMs and AI agents — selects the minimal code fragments needed to understand a change, under  |
| 33 | [nitagon0083/SpriteSystem](https://github.com/nitagon0083/SpriteSystem) | 0 | HTML | 2026-08-05 | Geminiの性能を最大化し作業を効率化するAI用OSプロンプト \| System prompt (AI OS) to maximize Gemini 3.0 performance and efficiency. |
| 34 | [Kiln-AI/Kiln](https://github.com/Kiln-AI/Kiln) | 5011 | Python | 2026-08-05 | Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset m |
| 35 | [mdesalvo/Morgana](https://github.com/mdesalvo/Morgana) | 9 | C# | 2026-08-05 | A magical witch assistant equipped with an enchanted grimoire powered by AI, yet shaped by you: your agents, your prompt |
| 36 | [flaqai/awesome-qwen-image-3](https://github.com/flaqai/awesome-qwen-image-3) | 1 | Ruby | 2026-08-05 | 🚀 World's largest Qwen Image 3.0 prompt library — 2000+ curated prompts with preview images, 16 languages. OpenAI's next |
| 37 | [Forest-Project-Lab/doctrine](https://github.com/Forest-Project-Lab/doctrine) | 1 | Python | 2026-08-05 | Stop stale specs from becoming code. A Markdown context-engineering blueprint for LLM coding agents: status, provenance, |
| 38 | [SrdjanCoric/skills](https://github.com/SrdjanCoric/skills) | 18 | HTML | 2026-08-05 | My personal Claude Code skills |
| 39 | [pranayprasad7001/generative-ai-projects](https://github.com/pranayprasad7001/generative-ai-projects) | 0 | Python | 2026-08-05 | Practical Generative AI projects covering LLMs, RAG, AI agents, SQL agents, tool calling, and Streamlit applications bui |
| 40 | [FoxsterDev/ai-research-hub](https://github.com/FoxsterDev/ai-research-hub) | 4 | Python | 2026-08-05 | Public AI operating layer for repo-attached engineering workflows, built around XUUnity. |
| 41 | [xiaozhoustefanie227/jean-gauthier-paris-gallery-skill](https://github.com/xiaozhoustefanie227/jean-gauthier-paris-gallery-skill) | 0 | Shell | 2026-08-05 | An AI art direction skill for transforming images into poetic paper studies inspired by Paris gallery archives. |
| 42 | [SaadLARAJ/Agentic-AI-OSINT](https://github.com/SaadLARAJ/Agentic-AI-OSINT) | 1 | Python | 2026-08-05 | LLM extraction pipeline with verified citations: entities and relations into a Neo4j knowledge graph, where every claim  |
| 43 | [ykstorm/goldset](https://github.com/ykstorm/goldset) | 0 | TypeScript | 2026-08-05 | Lock your AI app's behavior — golden datasets, LLM-as-judge, and structural assertions in CI. |
| 44 | [mayanksinghic/llm-response-evaluation](https://github.com/mayanksinghic/llm-response-evaluation) | 0 | Python | 2026-08-05 | Rubrics and tooling for evaluating LLM response quality — grounding, integration, helpfulness, and side-by-side model ra |
| 45 | [HaipingShi/coderail](https://github.com/HaipingShi/coderail) | 7 | Python | 2026-08-05 | A governance kit for AI coding agents. Keeps every task tied to the project's North Star with task contracts, harness ga |
| 46 | [skills-commons/skills-commons](https://github.com/skills-commons/skills-commons) | 0 | — | 2026-08-05 | Open library of reviewed, plain-Markdown skills for AI agents. Every skill passes a documented security review before me |
| 47 | [ariffazil/arifOS](https://github.com/ariffazil/arifOS) | 49 | Python | 2026-08-05 | [L0 CONSTITUTION] arifOS — constitutional MCP kernel. Law, identity, F1–F13, VAULT999. Judges but never executes. DITEMP |
| 48 | [filiksyos/gitreverse](https://github.com/filiksyos/gitreverse) | 1471 | TypeScript | 2026-08-05 | Reverse engineer any repo into it's original prompt |
| 49 | [F-e-u-e-r/opus-pack](https://github.com/F-e-u-e-r/opus-pack) | 2 | Python | 2026-08-05 | Distilled operating skills for daily-driver Claude models — few dense rules, executable gates over long prose. |
| 50 | [dottxt-ai/outlines](https://github.com/dottxt-ai/outlines) | 15517 | Python | 2026-08-05 | Structured Outputs |
<!-- TRACKER_TABLE_END -->
